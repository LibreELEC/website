---
layout: post
title: "LibreELEC (Nexus) 11.0.3"
description: "LE 11.0.3"
image: img/posts/icon-release-k20.jpg
---

The final stable version of LibreELEC 11.0.3 has been released, bringing Kodi (Nexus) v20.2.

## NEWS

There was no LibreELEC 11.0.2 release, we skipped it due a last minute Linux kernel fixes.
...
updates:
- kodi: update to 20.2
- linux: update to 6.1.38
- a complete [list of fixes](https://github.com/LibreELEC/LibreELEC.tv/compare/11.0.1...11.0.3)
...
Just add `?mirrorlist` after the link to show the SHA256 hash, for example `https://releases.libreelec.tv/LibreELEC-RPi4.arm-11.0.3.img.gz?mirrorlist` .  
