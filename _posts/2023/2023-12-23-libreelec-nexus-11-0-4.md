---
layout: post
title: "LibreELEC (Nexus) 11.0.4"
description: "LE 11.0.4"
...
- a complete [list of fixes](https://github.com/LibreELEC/LibreELEC.tv/compare/11.0.3...11.0.4)
...
Just add `?mirrorlist` after the link to show the SHA256 hash, for example `https://releases.libreelec.tv/LibreELEC-RPi4.arm-11.0.4.img.gz?mirrorlist` .  
