---
layout: post
title: "LibreELEC (Nexus) 11.0.6"
description: "LE 11.0.6"
image: img/posts/icon-release-k20.jpg
---

The truly-final-stable™ version of LibreELEC 11.0.6 has been released, fixing a Linux kernel bug that affected our last release.
...
updates:
- linux: update to 6.1.74
- a complete [list of fixes](https://github.com/LibreELEC/LibreELEC.tv/compare/11.0.5...11.0.6)
...
Just add `?mirrorlist` after the link to show the SHA256 hash, for example `https://releases.libreelec.tv/LibreELEC-RPi4.arm-11.0.6.img.gz?mirrorlist` .  
